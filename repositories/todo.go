...
type TodoRepository interface {
	...
	DeleteTodo(ID uint, todo models.Todo) (models.Todo, error)
}
...
func (r *repository) GetTodo(ID uint) (models.Todo, error) {
...
func (r *repository) DeleteTodo(ID uint, todo models.Todo) (models.Todo, error) {
